  ...
  const cardsData = [
    {
      title: 'Vitamina',
      kcalPerGram: '0 kcal',
      description: 'Fortalece o sistema imunológico, melhora a saúde da pele e auxilia no funcionamento do metabolismo.',
      items: [
        'Frutas cítricas',
        'Ovos e laticínios',
        'Grãos integrais',
    ...
    },
    {
      title: 'Mineral',
      kcalPerGram: '0 kcal',
      description: 'Fortalece os ossos, regula o equilíbrio hidroeletrolítico e auxilia na produção de energia.',
      items: [
