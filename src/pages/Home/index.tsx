...
export function Home() {
    return (
        <div>
            <Menu />
            <section className="min-h-screen md:mt-[70px] bg-gradient-to-br from-roxo_padrao to-roxo-gradiente px-4">
                <div className="flex flex-col md:flex-row justify-center items-center text-center gap-8">
                    <div className="flex flex-col text-center font-roboto">
                        ...
                        <p className="text-lg max-w-[500px] mt-5">
                            Seu recurso preferido para obter informações sobre nutrição e inspiração para exercícios físicos
                        </p>
                    </div>
            ...
            <section className="mb-12">
                <div className="flex flex-col justify-center items-center text-center">
                    ...
                    <h2 className="mt-2">Explore nossas ferramentas e informações sobre nutrição, academia e saúde!
                    </h2>
                </div>
                <div className="flex flex-col md:flex-row gap-12 mt-12 justify-center items-center">
                    <div className="flex flex-col justify-center items-center shadow-2xl p-8 transform transition duration-300 hover:scale-105">
                        <img src={nutricao} alt="Comida" className="rounded-full shadow-lg w-40 h-40 object-cover" />
                        ...
                        <Link to="/nutrition">
                            <button className="bg-roxo_padrao hover:bg-violet-700 transition-colors duration-300 ease-in-out text-gray-50 mt-4 px-6 py-2 rounded-full">Explorar</button>
                        </Link>
                    </div >
                    <div className="flex flex-col justify-center items-center shadow-2xl p-8 transform transition duration-300 hover:scale-105">
                        <img src={academia} alt="Pesos de academia" className="rounded-full shadow-lg w-40 h-40 object-cover" />
                        <h1 className="font-bold mt-4 text-lg">Academia</h1>
                        <h2 className="text-center max-w-[300px] mt-4">Explore tudo o que você precisa saber sobre o universo da academia.</h2>
                        <Link to="/gym">
                            <button className="bg-roxo_padrao hover:bg-violet-700 transition-colors duration-300 ease-in-out text-gray-50 mt-4 px-6 py-2 rounded-full">Explorar</button>
                        </Link>
                    </div>
                    <div className="flex flex-col justify-center items-center shadow-2xl p-8 transform transition duration-300 hover:scale-105">
                        <img src={calculadora} alt="Calculadora" className="rounded-full shadow-lg w-40 h-40 object-cover" />
                        <h1 className="font-bold mt-4 text-lg">Calculadoras</h1>
                        <h2 className="text-center max-w-[300px] mt-4">Saiba tudo sobre calculadoras de IMC, gordura corporal e muito mais!</h2>
                        <Link to="/calculators">
                            <button className="bg-roxo_padrao hover:bg-violet-700 transition-colors duration-300 ease-in-out text-gray-50 mt-4 px-6 py-2 rounded-full">Explorar</button>
                        </Link>
                    </div>
